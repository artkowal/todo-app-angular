...
import { TodoItemTailwind } from '../todo-item-tailwind/todo-item-tailwind';
...
@Component({
  selector: 'app-todo-list-tailwind',
  imports: [
    CommonModule,
    // TodoItem,
    TodoItemTailwind,
  ...
  templateUrl: './todo-list-tailwind.html',
  styleUrl: './todo-list-tailwind.css',
  animations: [
